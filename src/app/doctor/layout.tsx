...
import { LayoutDashboard, Users, Pill, Stethoscope, Settings, UserCircle } from "lucide-react";

const doctorNavItems: NavItem[] = [
  { title: "Dashboard", href: "/doctor/dashboard", icon: <LayoutDashboard /> },
  { title: "Patients", href: "/doctor/patients", icon: <Users /> },
  { title: "Appointments", href: "/doctor/appointments", icon: <Stethoscope /> }, // Could be nested under Patients or standalone
